 ...
 */
final class Version20190902145955 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE file ADD user_id INT DEFAULT NULL, ADD title VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, ADD format VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, ADD duration INT DEFAULT NULL, ADD pages_number INT DEFAULT NULL, ADD orientation VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
